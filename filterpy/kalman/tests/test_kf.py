...
#from pytest import approx  -this is missing from Labbe's code. Use a truncation/roundoff function instead
#define it in common.helpers - MB 2024
from common.helpers import approx  #MB 2024
from kalman.kalman_filter import KalmanFilter,update,predict,batch_filter
from common.kinematic  import kinematic_kf
from common.discretization import Q_discrete_white_noise
from common.helpers import Saver
from stats.stats import mahalanobis
...
def test_noisy_1d():
    ...
    for t in range(100):
        ...
        assert f.mahalanobis==approx(maha) ,"Mahalanobis distance underflow -exiting"
...
def test_steadystate():
    ...
    for i in range(100):
        ...
        assert cv.mahalanobis==approx(maha) ,"Mahalanobis distance underflow -exiting"
